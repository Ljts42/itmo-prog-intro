...
public class RunMe {
    ...
    private static void key5(final byte[] password) {
        ...
        // a = (n / 2) * (n / 2 + 1) - n;
        // b = a + 3 * (n / 3) * (n / 3 + 1) / 2 - n / 3 * 2;
        // c = b + 2 * (n / 4) * (n / 4 + 1) - n / 4 * 2;
        // d = c + 5 * (n / 5) * (n / 5 + 1) / 2 - n / 5 * 2;

        print(5, 345505356L, password);
    }
    ...
    private static void key8(final byte[] password) {
        ...
        // int result = hash;
        // for (int i = 0; i < SMALL_REPEAT_COUNT - 1; i++) {
        //     for (int j = 0; j < 52; j++) {
        //         result *= 31;
        //     }
        //     result += hash;
    ...
    private static void key9(final byte[] password) {
        ...
        // int hash = PATTERN.hashCode();
        // int result = hash;
        // for (int i = 0; i < LARGE_REPEAT_COUNT - 1; i++) {
        //     for (int j = 0; j < 52; j++) {
        //         result *= 31;
        //     }
        //     result += hash;
    ...
    private static void key11(final byte[] password) {
        ...
        // long result = 0;
        // for (int i = 1; i < 531293; i++) {
        //     result += i * password[i % password.length];
        // }

        print(11, 3363730166715L, password);
    }
    ...
    private static void key12(final byte[] password, final long depth, final long result) {
        ...
        //     res = (res ^ 857032297) + i * 13;
        // }
        
        print(12, 65009898904178048L, password);
    }
    ...
    private static void key13(final byte[] password) {
        ...
        // sum_of_all_natural_numbers = - 1 / 12
        // -737916 / 12

        print(13, -61493, password);
    }
    ...
    private static void key15(final byte[] password) {
        ...
        // 1000000087892998
        // cicle 4536
        // for (long i = (1000_000_000_000_000L + ByteBuffer.wrap(password).getInt()) % 4536; i >= 0; i--) {
        //     a1 ^= a2;
        //     a2 += a3 & a1;
        //     a3 -= a1;
        // }
